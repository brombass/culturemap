...
import { CultureMapHeroArt } from "./culture-map-hero-art";
...
export function Hero() {
  return (
    <section id="top" className="relative overflow-hidden">
      ...
      />
      <div className="mx-auto grid max-w-6xl items-center gap-8 px-4 pb-14 pt-14 sm:px-6 sm:pt-10 lg:grid-cols-[minmax(0,1.2fr)_minmax(300px,0.8fr)] lg:gap-10 lg:pb-20">
        <div>
